...
<div class="row mb-4 mb-xl-6 mb-xxl-4 gy-3 justify-content-between">
    ...
    <div class="col-auto">
        <div class="d-flex gap-3"><a class="btn btn-phoenix-primary" href="#!"><span
                    class="fa-solid fa-plus me-2"></span>New Package</a><a class="btn btn-primary px-4 px-sm-11"
                href="#!"><span class="fa-regular fa-calendar-days me-2"></span>Book Now</a></div>
    </div>
</div>
<div class="row gx-3">
    <div class="col-xxl-7">
            ...
            <div class="col-12 col-xl-5 col-xxl-12">
                <div class="row g-0">
                        ...
                        <div class="d-md-flex flex-between-center">
                            ...
                            <div class="mt-4 mt-md-0">
                                <h3 class="text-body-highlight mb-2">$2,345.00</h3><span
                                    ...
                                    class="fs-9 text-body-secondary d-block d-sm-inline mt-1">From last month</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-md-flex flex-between-center">
                            ...
                            <div class="mt-3 mt-md-0">
                                <h3 class="text-body-highlight mb-2">1,432</h3><span
                                    ...
                                    class="fs-9 text-body-secondary text-nowrap d-block d-sm-inline mt-1">From last
                                    month</span>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="d-md-flex flex-between-center">
                            <div class="echart-commission order-sm-0 order-md-1" style="height: 54px; width: 54px">
                            </div>
                            <div class="mt-3 mt-md-0">
                    ...
                    <div class="col-6 col-xl-12 col-xxl-6 py-4 ps-4 ps-sm-5 ps-xl-0 ps-xxl-5">
                        ...
                        <div class="d-md-flex flex-between-center">
                            <div class="chart-cancel-booking order-sm-0 order-md-1" style="height:54px; width:78px">
                            </div>
                            <div class="mt-3 mt-md-0">
            ...
            <div class="col-12 col-xl-7 col-xxl-12">
                <div class="mt-5 mt-xl-0 mt-xxl-5 mb-5 mb-xxl-0">
                    ...
                    <div class="echart-financial-Activities"
                        data-options='{"optionOne":"profit","optionTwo":"revenue","optionThree":"expanses"}'></div>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tbody class="list" id="table-country-wise-visitors">
                                    <tr>
                                        <td class="py-2 white-space-nowrap ps-0 country"><a
                                                ...
                                                href="#!"><img src="<?= base_url('assets/img/country/india-2.png'); ?>" alt=""
                                                    width="40" />
                                    ...
                                    <tr>
                                        <td class="py-2 white-space-nowrap ps-0 country"><a
                                                class="d-flex align-items-center text-primary py-md-1 py-xxl-0"
                                                href="#!"><img src="<?= base_url(''); ?>assets/img/country/china-2.png" alt=""
                                                    width="40" />
                                    ...
                                    <tr>
                                        <td class="py-2 white-space-nowrap ps-0 country"><a
                                                class="d-flex align-items-center text-primary py-md-1 py-xxl-0"
                                                href="#!"><img src="<?= base_url(''); ?>assets/img/country/usa-2.png" alt=""
                                                    width="40" />
                    ...
                    <div class="card-footer pt-3 border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="mb-0 d-none d-sm-block me-3 fw-semibold text-body"
                                data-list-info="data-list-info"></p><a class="fw-bold fs-9 ms-auto" href="#!">View
            ...
            <div class="col-12 col-md-6 col-xxl-12">
                <div class="card h-100">
                    <div class="card-header border-0 pb-2 d-flex justify-content-between align-items-start">
                        ...
                        </div><a class="btn btn-sm btn-phoenix-secondary d-flex align-items-center w-max-content"
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="bg-holder bg-card"
                        style="background-image:url(<?= base_url(''); ?>assets/img/spot-illustrations/39.png);background-position: bottom right 0px; background-size: auto;">
                    </div>
                    <!--/.bg-holder-->
                    <div class="card-body z-5">
                        <div>
                            <h3 class="text-body-highlight mb-3">Phoenix integrations</h3>
                            <p class="text-body-tertiary mb-4 w-75 w-xl-100">Phoenix improves efficiency instantly
                                and effortlessly <br class="d-none d-xxl-block"> by allowing easy & simple
                                connection <br class="d-none d-xl-block"> to other popular programs</p><a
                                class="btn btn-sm btn-phoenix-primary" href="#!"> <span
                    ...
                    <div class="col-12 col-md-auto col-xl-12 col-xxl-auto flex-1 h-md-100">
                        <div class="d-flex flex-column justify-content-between h-md-100 h-xl-auto h-xxl-100">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 text-primary"><span class="fw-bold"
                                        data-feather="trending-up" style="width: 24px; height: 24px"></span>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 text-danger"><span class="fw-bold"
                                        data-feather="trending-down" style="width: 24px; height: 24px"></span>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 text-success"><span class="fw-bold"
                                        data-feather="trending-up" style="width: 24px; height: 24px"></span>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 text-warning"><span class="fw-bold"
                                        data-feather="trending-up" style="width: 24px; height: 24px"></span>
            ...
            <div class="col-auto flex-1">
                <div class="d-flex flex-between-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-none d-sm-block"><a class="fw-semibold text-nowrap" href="#!"
                                data-list-view="*">View all<span class="fas fa-angle-right ms-1"
                                    data-fa-transform="down-1"></span></a><a class="fw-semibold d-none text-nowrap"
                                href="#!" data-list-view="less">View Less</a></div><button
                            class="btn btn-phoenix-primary px-3 me-1 ms-sm-4" type="button" title="Previous"
                            data-list-pagination="prev"><span class="fas fa-chevron-left"
            ...
            <table class="table fs-9 mb-0 border-top border-translucent">
                <thead>
                    <tr>
                        ...
                        <th class="sort text-start align-middle text-body-tertiary" scope="col" data-sort="weather"
                            style="width:250px;">WEATHER</th>
                        <th class="sort align-middle text-body-tertiary" scope="col" data-sort="route"
                            style="width:180px;">ROUTE</th>
                        <th class="sort align-middle text-body-tertiary" scope="col" style="min-width:280px;"
                            data-sort="destination">DESTINATION</th>
                        <th class="sort text-end align-middle text-body-tertiary" scope="col" data-sort="status"
                            style="min-width:120px;">STATUS</th>
                        <th class="sort align-middle text-end text-body-tertiary" scope="col" data-sort="time"
                            style="min-width:200px;">TIME</th>
                ...
                <tbody class="list" id="table-flights-body">
                    <tr>
                        ...
                        <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                href="#!"><img src="<?= base_url(''); ?>assets/img/brands/phoenix-firelines.png" alt="" width="32" />
                        ...
                        <td class="align-middle route pe-5">
                            <div class="d-flex align-items-center gap-2"><img src="<?= base_url(''); ?>assets/img/country/usa.png"
                                    alt="" width="16" />
                                ...
                                <p class="mb-0 fw-semibold text-bold">YVR</p><img
                                    src="<?= base_url(''); ?>assets/img/country/canada.png" alt="" width="16" />
                            </div>
                        </td>
                        ...
                        <td class="align-middle text-end">
                            <div class="btn-reveal-trigger"><button
                                ...
                                <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                                        href="#!">Track flight</a><a class="dropdown-item" href="#!">Download</a><a
                    ...
                    <tr>
                        ...
                        <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                href="#!"><img src="<?= base_url(''); ?>assets/img/brands/qatar-airways.png" alt="" width="32" />
                        ...
                        <td class="align-middle route pe-5">
                            <div class="d-flex align-items-center gap-2"><img
                                    src="<?= base_url(''); ?>assets/img/country/denmark.png" alt="" width="16" />
                                <p class="mb-0 fw-semibold text-bold">EBJ</p><span
                                    class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                                <p class="mb-0 fw-semibold text-bold">CDG</p><img
                                    src="<?= base_url(''); ?>assets/img/country/south-korea.png" alt="" width="16" />
                            </div>
                        </td>
                        <td class="align-middle destination pe-5 pe-xxl-7">
                            <div class="progress overflow-visible" role="progressbar"
                    ...
                    <tr>
                        ...
                        <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                href="#!"><img src="<?= base_url(''); ?>assets/img/brands/jal.png" alt="" width="32" />
                        ...
                        <td class="align-middle route pe-5">
                            <div class="d-flex align-items-center gap-2"><img src="<?= base_url(''); ?>assets/img/country/china.png"
                                    alt="" width="16" />
                                <p class="mb-0 fw-semibold text-bold">GOT</p><span
                                    class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                                <p class="mb-0 fw-semibold text-bold">BCN</p><img
                                    src="<?= base_url(''); ?>assets/img/country/usa.png" alt="" width="16" />
                            </div>
                        </td>
                        <td class="align-middle destination pe-5 pe-xxl-7">
                            <div class="progress overflow-visible" role="progressbar"
                        ...
                        <td class="status align-middle text-end"><span
                                class="badge badge-phoenix fs-10 badge-phoenix-success">Departure</span></td>
                        <td class="align-middle text-end time">
                            <div class="d-flex justify-content-end align-items-center gap-2 mb-2"><span
                                    class="fa-regular fa-clock text-body"> </span><span
                                    class="text-body fw-semibold">07:23 PM</span></div>
                    ...
                    <tr>
                        ...
                        <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                href="#!"><img src="<?= base_url(''); ?>assets/img/brands/emirates.png" alt="" width="32" />
                        ...
                        <td class="align-middle route pe-5">
                            <div class="d-flex align-items-center gap-2"><img src="<?= base_url(''); ?>assets/img/country/qatar.png"
                                    alt="" width="16" />
                                <p class="mb-0 fw-semibold text-bold">DIA</p><span
                                    class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                                <p class="mb-0 fw-semibold text-bold">OSL</p><img
                                    src="<?= base_url(''); ?>assets/img/country/norway.png" alt="" width="16" />
                            </div>
                        </td>
                        <td class="align-middle destination pe-5 pe-xxl-7">
                            <div class="progress overflow-visible" role="progressbar"
        ...
        <div class="mapbox-container">
            <div class="position-relative">
                ...
                <div class="mapbox-control-btn flight-map-control-btn"><button
                        class="zoomIn d-none d-md-block"><span class="fa-solid fa-plus"></span></button><button
                        class="zoomOut d-none d-md-block"><span class="fa-solid fa-minus"></span></button><button
            ...
            <div class="position-absolute top-0 w-100 mt-3 mt-md-5 px-3 px-md-5 px-xl-7">
                <div class="d-flex align-items-center bg-secondary overflow-hidden rounded-1" style="height: 46px">
                    <div class="h-100 px-3 d-flex align-items-center bg-danger-subtle position-relative z-5"><span
                            class="fa-solid fa-circle text-danger me-md-2"></span>
                        ...
                        <div class="swiper theme-slider"
                            ...
                            <div class="swiper-wrapper swiper-continuous-autoplay">
                                <div class="swiper-slide w-auto">
                                    <div class="d-flex align-items-center">
                                        <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">1</h6><img
                                            class="me-1" src="<?= base_url(''); ?>assets/img/brands/emirates.png" alt=""
                                            width="16" />
                                        <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                ...
                                <div class="swiper-slide w-auto">
                                    <div class="d-flex align-items-center">
                                        <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">2</h6><img
                                            class="me-1" src="<?= base_url(''); ?>assets/img/brands/phoenix-firelines.png" alt=""
                                            width="16" />
                                        <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                        <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                            class="fa-solid fa-plane text-primary mx-2"></span>
                                ...
                                <div class="swiper-slide w-auto">
                                    <div class="d-flex align-items-center">
                                        <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">3</h6><img
                                            class="me-1" src="<?= base_url(''); ?>assets/img/brands/qatar-airways.png" alt=""
                                            width="16" />
                                        <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                        <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                            class="fa-solid fa-plane text-primary mx-2"></span>
                                ...
                                <div class="swiper-slide w-auto">
                                    <div class="d-flex align-items-center">
                                        <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">4</h6><img
                                            class="me-1" src="<?= base_url(''); ?>assets/img/brands/jal.png" alt="" width="16" />
                                        <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                        <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                            class="fa-solid fa-plane text-primary mx-2"></span>
                                        <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                                ...
                                <div class="swiper-slide w-auto">
                                    <div class="d-flex align-items-center">
                                        <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">5</h6><img
                                            class="me-1" src="<?= base_url(''); ?>assets/img/brands/jal.png" alt="" width="16" />
                                        <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                        <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                            class="fa-solid fa-plane text-primary mx-2"></span>
                    ...
                    <div class="col-auto">
                        <table class="fs-9">
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 class="mb-0 text-nowrap fw-semibold text-body-tertiary">FF-SCA001</h6>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="text-body-tertiary pe-2">: </td>
                                <td>
                                    <h6 class="mb-0 text-nowrap fw-semibold text-body-tertiary">Appa 707-RTX</h6>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="text-body-tertiary pe-2">: </td>
                                <td>
                                    <h6 class="mb-0 text-nowrap fw-semibold text-body-tertiary">450 km/h</h6>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-auto">
                        <table class="fs-9">
                            ...
                            <tr>
                                ...
                                <td class="text-body-tertiary pe-2">: </td>
                                <td>
                                    <h6 class="mb-0 text-nowrap fw-semibold text-body-tertiary">Skybison1</h6>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="text-body-tertiary pe-2">: </td>
                                <td>
                                    <h6 class="mb-0 text-nowrap fw-semibold text-body-tertiary">12 hrs 57 mins</h6>
                                </td>
                            </tr>
                        </table>
                    </div>
